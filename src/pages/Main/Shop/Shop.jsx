...
//   return (
//     <div className="max-w-[1520px]  py-8 ">
//       {/* Header with Add New Item button */}
//       <div className="flex justify-between items-center mb-8">
//         <h1 className="text-3xl font-bold text-gray-800">Product Listing</h1>
//         <button className="bg-orange-500 hover:bg-orange-600 text-white rounded-full px-6 py-2 flex items-center transition-colors duration-200">
...
//                       <img
//                         src={
//                           item.image || "/placeholder.svg?height=220&width=220"
//                         }
//                         alt={item.name}
